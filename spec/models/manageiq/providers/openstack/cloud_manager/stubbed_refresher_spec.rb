...
describe ManageIQ::Providers::Openstack::CloudManager::Refresher do
  ...
  describe "refresh" do
    ...
    def setup_mocked_collector
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:image_service).and_return(double(:name => "not-glance"))
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:availability_zones).and_return(mocked_availability_zones)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:availability_zones_compute).and_return(mocked_availability_zones)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:availability_zones_volume).and_return(mocked_availability_zones)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:cloud_services).and_return(mocked_cloud_services)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:flavors).and_return(mocked_flavors)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:host_aggregates).and_return(mocked_host_aggregates)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:images).and_return(mocked_miq_templates)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:key_pairs).and_return(mocked_key_pairs)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:quotas).and_return(mocked_quotas)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:quotas).and_return([])
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:quotas).and_return([])
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:orchestration_stacks).and_return(mocked_orchestration_stacks)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:vms).and_return(mocked_vms)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:vnfs).and_return(mocked_vnfs)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:vnfds).and_return(mocked_vnfds)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:tenants).and_return(mocked_cloud_tenants)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:private_flavor).and_return(nil)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:volume_templates).and_return(mocked_volume_templates)
      allow_any_instance_of(ManageIQ::Providers::Openstack::Inventory::Collector::FullCollection).to receive(:volume_snapshot_templates).and_return(mocked_volume_snapshot_templates)
